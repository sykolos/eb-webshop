                            ...
                            <tr>
                                ...
                                <td>
                                    <div style="display:flex; align-items:center; gap:10px">
                                        {{$color->code}} <span style="display: inline-block; width:30px; height:30px; background:{{$color->code}}; border-radius:50%;"></span>    
                                    </div>                                    
                                </td>
                                <td></td>
                                <td>{{\Carbon\Carbon::parse($color->created_at)}}</td>
                                <td>
