...
@section('title','Szállítási cím szerkesztése')
@section('content')
        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-8 col-sm-12">
                <section class="account-modify-box">
                    <p class="account-modify-box-title">Szállítási cím szerkesztése</p>

                    <form action="{{ route('shipping.update', $address) }}" method="POST">
                        @csrf
                        @method('PUT')

                        {{-- ugyanaz az űrlap, mint create-nél, de $address-ből töltve --}}
                        <div class="row mb-1">
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="receiver" id="receiver"
                                        ...
                                        value="{{ old('receiver', $address->receiver) }}" required>
                                    @error('receiver')
                            ...
                            <div class="col-md-2">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="zipcode" id="zipcode" maxlength="4"
                                        ...
                                        value="{{ old('zipcode', $address->zipcode) }}" required>
                                    @error('zipcode')
                                    <span class="invalid-feedback">
                                        <strong>{{ $message }}</strong>
                                    </span>
